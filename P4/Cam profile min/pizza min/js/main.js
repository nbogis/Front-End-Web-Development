...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.srcset = "images/pizza_1x.png 1x, images/pizza.png 2x";
...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    var newwidth;
    /** changed the pizza width depending on the size */
    switch(size) {
      case "1":
        newwidth = 25;
        break;
    ...
    /** grab all randomPizzaContainer outside the loop */
    var randomPizzas = document.getElementsByClassName("randomPizzaContainer");
    /** use % for pizza sizes instead of px */
...
/** grab the randomPizaa element outside the loop */
var pizzasDiv = document.getElementById("randomPizzas");
/** add 64 pizza elemetns to random Pizzas. The code used to generate 100 but reducing it shows better performance */
for (var i = 0; i < 64; i++) {
...
function updatePositions() {
  ...
  /** grab decleration and single assignments outside the loop since documents take some time to grad*/
  var scrolling = (document.body.scrollTop / 1250);
  /** numbers is a value between 0 and 4 and it's used to replace (i % 5) */
  var numbers = -1;
  var phase;
  for (var i = 0; i < items.length; i++) {
    ...
    /** define the movements of the pizzas */
    phase = Math.sin(scrolling + numbers);
    /** causes heavy repainting. solution is to make the background pizzas in a separate layer by using 3d translation over the x axis */
    //// items[i].style.left = items[i].basicLeft + 100 * phase + 'px';
    items[i].style.transform = "translate3d(" + 550 * phase  + "px,0,0)";
  }
...
/** reduce the number of pizzas from 200 to a number based on the viewport height. it was found sufficient for the viewing window */
document.addEventListener('DOMContentLoaded', function() {
  var cols = 3;
  var s = 200;  
  /** generate moving pizzas depending on the viewport height. 64 seems a good division to generate few pizzas */ 
  var numberPizzas = window.innerHeight / 64;
  console.log(numberPizzas);
  for (var i = 0; i < numberPizzas; i++) {
    var elem = document.createElement('img');
    elem.className = 'mover';
    elem.src = "images/pizza_1x.png";
    elem.srcset = "images/pizza_1x.png 1x, images/pizza.png 2x";
    elem.style.height = "100px";
    elem.style.width = "73.333px";
    /** no need for basicLeft since we use 3d translation */
